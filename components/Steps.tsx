...
const steps = [
  {
    ...
    detail: "An archivist visits, photographs every garment, and tags each piece. Your wardrobe is catalogued into a digital archive in two hours. You do nothing except let us in.",
  ...
  },
  {
    ...
    detail: "Everything moves to a climate-controlled Ubique facility. Cleaned, pressed, stored individually — ready to be pulled at any moment, in perfect condition.",
  ...
  },
  {
    ...
    detail: "Open the app to see your curated outfit for the day. Accept it, swap a piece, or browse your full digital wardrobe — every garment photographed, tagged, and searchable. Once you accept, we deliver.",
  ...
  },
  {
    ...
    detail: "Your outfit arrives before you need it. We collect what you wore yesterday, clean it, and return it to storage. The same cycle, every day, without you making a single decision.",
